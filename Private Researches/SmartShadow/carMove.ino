...
功能函数
	...
	输入参数：
		...
		rightSpeed：
			...
			说明：负值为后退，0为停止，正值为前进
***************************************************************************/
int Left_motor_go = 4; //左电机前进管脚
//int Left_motor_back = 8;      //左电机后退管脚
int Right_motor_go = 2; //右电机前进管脚
//int Right_motor_back = 4;     //右电机后退管脚

int Left_motor_pwm = 5;  //左电机控速管脚 PWMA
int Right_motor_pwm = 6; //右电机控速管脚 PWMB
